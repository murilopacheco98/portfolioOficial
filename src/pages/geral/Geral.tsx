    ...
    <div className="flex">
      ...
      {on && (
        <div className="overflow-y-scroll h-[calc(100vh-25px)] mt-[25px] bg-opacity-[1%] bg-[#070419] w-[calc(100vw-200px)]">
          ...
          <div className="font-light mx-[5vw] lg:mx-[10vw] text-[16px] lg:text-[18px] text-justify">
            ...
            programação e durante a pandemia vi a possibilidade de entrar na
            área, por isso me dediquei bastante e entrei no curso da Growdev de
            Full Stack Developer. <br /> Apesar da dificuldade sou apaixonado
            pela área e me dediquei bastante para estudar e montar meus projetos
            e portfólio e entrar na área de desenvolvimento.
          </div>
          <div className="font-semibold flex justify-center mt-[20px] mb-[10px] text-[20px]">
            Conhecimentos
          </div>
          ...
          <div className="mb-[15px] flex text-justify font-light mx-[5vw] lg:mx-[10vw] text-[16px] lg:text-[18px]">
            ...
            aplicação. O candidato pode se cadastrar e logar no sistema,
            escolher as vagas disponíveis e se candidatar, após isso esperar a
            resposta e ver as vagas no qual ele se inscreveu.
          </div>
          <div className="font-semibold flex justify-center mt-[20px] mb-[10px] text-[20px]">
            Formação
          </div>
      ...
      {!on && (
        <div className="overflow-y-scroll h-[calc(100vh-25px)] mt-[25px] text-white bg-opacity-95 bg-[#070419] w-[calc(100vw-200px)]">
          <Abas />
          <div className="flex justify-center pt-[20px] mb-[10px] text-[20px]">
            Sobre mim
          </div>
          <div className="font-light mx-[5vw] lg:mx-[10vw] text-[16px] lg:text-[18px] text-justify">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Estou em transição de área, ao
